...
const strings: Dict = {
  ...
  purchase: { hi: 'वस्तु क्रय', en: 'Purchase' },
  pacs_services: { hi: 'ऋृण', en: 'Loans' },
  procurement_status: { hi: 'खरीद की स्थिति', en: 'Procurement Status' },
  sell: { hi: 'वस्तु विक्रय', en: 'Sell' },
  // Loans
  // Purchase flow
  select_product_type: { hi: 'खरीद के लिए प्रकार चुनें', en: 'Select type to purchase' },
  fertilizers: { hi: 'उर्वरक', en: 'Fertilizers' },
  seeds: { hi: 'बीज', en: 'Seeds' },
  checkout: { hi: 'चेकआउट', en: 'Checkout' },
  book_slot: { hi: 'स्लॉट बुक करें', en: 'Book slot' },
  select_date: { hi: 'दिनांक चुनें', en: 'Select date' },
  select_time_slot: { hi: 'समय स्लॉट चुनें', en: 'Select time slot' },
  slots_remaining: { hi: 'शेष स्लॉट: {n}', en: 'Remaining: {n}' },
  sold_out: { hi: 'भर गया', en: 'Sold out' },
  booking_confirmed: { hi: 'स्लॉट बुकिंग सफल', en: 'Slot booking successful' },
  ...
  // Loans flow
  loans: { hi: 'ऋृण', en: 'Loans' },
  loans_apply_tab: { hi: 'आवेदन', en: 'Apply' },
  loans_history_tab: { hi: 'इतिहास', en: 'History' },
  loans_application: { hi: 'आवेदन पत्र', en: 'Application' },
  loans_type_agri: { hi: 'कृषि', en: 'Agricultural' },
  loans_type_non_agri: { hi: 'गैर-कृषि', en: 'Non-Agricultural' },
  loans_purpose: { hi: 'ऋण का उद्देश्य', en: 'Purpose of loan' },
  loans_amount: { hi: 'ऋण राशि (₹)', en: 'Loan amount (₹)' },
  loans_tenure_months: { hi: 'अवधि (महीने)', en: 'Tenure (months)' },
  loans_members: { hi: 'सदस्य संख्या', en: 'No. of members' },
  loans_member_limit: { hi: 'सदस्य सीमा', en: 'Member limit' },
  loans_collateral: { hi: 'जमानत (यदि कोई)', en: 'Collateral (if any)' },
  loans_income: { hi: 'वार्षिक आय (₹)', en: 'Annual income (₹)' },
  submit: { hi: 'जमा करें', en: 'Submit' },
  history: { hi: 'इतिहास', en: 'History' },
  unit_quintal: { hi: 'क्विंटल', en: 'quintal' },
  // Help and validation
  ...
  aadhaar_help_tip: { hi: 'केवल सत्यापन हेतु प्रयोग। हम आपका आधार साझा नहीं करते।', en: 'Used for verification only. We do not share your Aadhaar.' },
  land_area_help_tip: { hi: 'हेक्टेयर में दर्ज करें (जैसे 1.25)। अनुमानित मान भी स्वीकार्य हैं।', en: 'Enter in hectares (e.g., 1.25). Approximate values are okay.' },
  // OTP
  ...
  // Seed item names
  seed_wheat: { hi: 'गेहूं बीज', en: 'Wheat seeds' },
  seed_paddy: { hi: 'धान बीज', en: 'Paddy seeds' },
  seed_mustard: { hi: 'सरसों बीज', en: 'Mustard seeds' },
  seed_gram: { hi: 'चना बीज', en: 'Gram seeds' },
  // Errors
